...
class NewCustomer(models.Model):
    created_by=models.ForeignKey(CustomUser,on_delete=models.CASCADE,null=True,blank=True,editable=False)
    ...
    state=models.CharField(max_length=40, choices=your_choices_1,null=False)
    plan_offered=models.CharField(max_length=32, choices=your_choices_2,null=False)
